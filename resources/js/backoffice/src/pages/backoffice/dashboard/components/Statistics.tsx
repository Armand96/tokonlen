...
const Statistics = ({ data }: any) => {
	return (
		<div className="grid 2xl:grid-cols-6 md:grid-cols-3 grid-cols-1 gap-6 mb-6">
			...
			<div className="2xl:col-span-2 md:col-span-0">
				<StatisticsWidget icon='ri-dashboard-line' variant={'text-blue-500'} cardTitle={'Total Diskon Aktif'}  stats={data?.totalDisc}  />
			</div>

			<div className="2xl:col-span-2  md:col-span-0  ">
				<StatisticsWidget icon=' ri-sparkling-line' variant={'text-yellow-500'} cardTitle={'Total variant'}  stats={data?.totalCategory}  />
			</div>
