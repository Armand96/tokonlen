...
const TopVisitedProductMonthly = ({ data }: any) => {
	return (
		<div className="card">
			<div className="card-header flex justify-between items-center">
				<h4 className="card-title">1 Bulan ini</h4>
			</div>
			<div className="relative overflow-x-auto">
				<table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
					...
					<tbody>
						{(data?.topTenVisitedProductMonthly || []).map((product, idx) => (
							<tr key={idx}>
...
export default TopVisitedProductMonthly
